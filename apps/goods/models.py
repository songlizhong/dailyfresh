...
class GoodsCategory(BaseModel):
    ...
    logo = models.CharField(max_length=100, verbose_name="图标标示")
...
class IndexSlideGoods(BaseModel):
    ...
    sku = models.ForeignKey(GoodsSPU, verbose_name="商品SKU")
...
class IndexCateoryGoods(BaseModel):
    """主页分类商品展示"""
    DISPLAY_TYPE_CHOICE = (
        (0, "标题"),
        (1, "图片")
    ...
    display_type = models.SmallIntegerField(choices=DISPLAY_TYPE_CHOICE, verbose_name="展示类型")
    index = models.SmallIntegerField(default=0, verbose_name="顺序")
